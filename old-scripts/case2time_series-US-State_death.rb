...
start_i_j = 11
max_row = 1
CSV.foreach("CSSEGISandData/COVID-19/csse_covid_19_data/csse_covid_19_time_series//time_series_covid19_deaths_US.csv", "r:UTF-8") do |row|
...
CSV.open('time_series_covid19_deaths_US_State.csv','w') do |csv| # output to csv file
  o = []
